...
<head>
  ...
  <script type="module" crossorigin src="{{ asset('assets//elements-BRq9ZB2q.js') }}"></script>
                                    ...
                                    <template x-for="result in results" :key="result.title">
                                        <a :href="result.url" class="d-block px-3 py-2 text-decoration-none text-dark border-bottom">
                                            <div class="d-flex align-items-center">
                                                <i class="bi bi-puzzle me-2 text-muted"></i>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse show" id="elementsSubmenu">
                                    <ul class="nav nav-submenu">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="./elements.html">
