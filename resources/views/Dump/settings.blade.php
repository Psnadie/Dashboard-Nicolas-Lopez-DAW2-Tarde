...
<head>
    ...
    <title>Settings & Preferences - Modern Bootstrap Admin</title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="Application settings and user preferences configuration">
    <meta name="keywords" content="bootstrap, admin, dashboard, settings, preferences, configuration">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">  <script type="module" crossorigin src="{{ asset('assets//main-f0Mg-34g.js') }}"></script>
  <script type="module" crossorigin src="{{ asset('assets//settings-CYDU_ohR.js') }}"></script>
