...
<head>
    ...
    <!-- ApexCharts CDN -->
    <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>  <script type="module" crossorigin src="{{ asset('assets//main-f0Mg-34g.js') }}"></script>
  <script type="module" crossorigin src="{{ asset('assets//products-Bf5ZuPHt.js') }}"></script>
